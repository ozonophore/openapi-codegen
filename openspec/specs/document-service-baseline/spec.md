...
Top-level index spec for the document-service capability baseline, mapping domain spec folders to CLI entry points and tracking the consolidation of standalone specs into baseline domains.
