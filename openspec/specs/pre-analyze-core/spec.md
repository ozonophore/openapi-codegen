...
`preAnalyze` stage loading of generator plugins from the effective item configuration, matching `OpenApiClient.generateSingle` behavior for plugin resolution and `strictPluginMode` propagation.
