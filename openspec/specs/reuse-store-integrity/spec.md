...
Integrity and durability of `ReuseStore`: contentHash verification, atomic manifest
writes, orphan cleanup on bad manifests, multi-entry `nameKindIndex`, and `specItems` GC sync.
