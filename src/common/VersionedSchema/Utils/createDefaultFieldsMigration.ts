 ...
 * @returns
 */
export function createDefaultFieldsMigration<From extends Record<string, any>>(fromVersion: string, toVersion: string, defaultFields: Record<string, any>): SchemaMigrationPlan<From, From> {
    return {
        fromVersion,
        toVersion,
