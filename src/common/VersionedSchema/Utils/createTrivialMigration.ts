 ...
 */
export function createTrivialMigration<From extends Record<string, any>>(fromVersion: string, toVersion: string, description?: string): SchemaMigrationPlan<From, From> {
    return {
        fromVersion,
        toVersion,
