const ROOT_MARAUDER_KEYS = ['autoSelect', 'anomalyDetection', 'anomalyExploitation', 'exploitAnomalies'] as const;
const ITEM_MARAUDER_KEYS = ['anomalyDetection', 'anomalyExploitation'] as const;
