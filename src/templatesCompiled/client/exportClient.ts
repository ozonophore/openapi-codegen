...
export default {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "import { "
    + ((stack1 = alias2(alias1(depth0, "name", {"start":{"line":12,"column":11},"end":{"line":12,"column":15}} ), depth0)) != null ? stack1 : "")
    + " } from './services/"
    + ((stack1 = alias2(alias1(depth0, "name", {"start":{"line":12,"column":39},"end":{"line":12,"column":43}} ), depth0)) != null ? stack1 : "")
    + "';\n";
  ...
  return "    "
    + ((stack1 = lookupProperty(helpers,"camelCase").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"name"),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":51,"column":4},"end":{"line":51,"column":22}}})) != null ? stack1 : "")
    + ": new "
    + ((stack1 = container.lambda(container.strict(depth0, "name", {"start":{"line":51,"column":30},"end":{"line":51,"column":34}} ), depth0)) != null ? stack1 : "")
    + "(executor),\n";
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"header"),depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + "';\n\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,lookupProperty(depth0,"services"),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":11,"column":0},"end":{"line":13,"column":9}}})) != null ? stack1 : "")
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,lookupProperty(depth0,"services"),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":50,"column":4},"end":{"line":52,"column":13}}})) != null ? stack1 : "")
    + "  };\n}\n";
