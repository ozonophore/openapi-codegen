...
export function mergeNestedCliOptions<T extends Record<string, unknown>>(cliOptions: T, nestedOptions: NestedMarauderOptions): T {
    ...
    for (const groupKey of ['autoSelect', 'anomalyDetection', 'anomalyExploitation'] as const) {
