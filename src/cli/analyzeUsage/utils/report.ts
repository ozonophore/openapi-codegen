...
export class Reporter {
  ...
  static renderConsole(findings: Finding[], coverage: CoverageReport): void {
    console.log("\n📊 API Coverage:");
    console.log(
      `   Methods: ${coverage.methods.used}/${coverage.methods.total} (${coverage.methods.percent})`,
    );
    console.log(
      `   Schemas: ${coverage.schemas.used}/${coverage.schemas.total} (${coverage.schemas.percent})`,
    );
    console.log(
      `   Models:  ${coverage.models.used}/${coverage.models.total} (${coverage.models.percent})`,
    );
