...
describe('@unit: sortByRequiredExtended', () => {
    // Tests for comparison between different groups
    test('must sort the groups in order: required, required-with-default, optional, optional-with-default', () => {
        const params = [
    ...
    test('must sort by name within the required-with-default group', () => {
        const params = [
    ...
    test('it must sort by name within the optional-with-default group', () => {
        const params = [
