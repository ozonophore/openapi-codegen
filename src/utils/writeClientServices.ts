 ...
 * @param useCancelableRequest Use CancelablePromise wrapper to request
...
export async function writeClientServices(options: IWriteClientServices): Promise<void> {
    const { services, templates, outputPath, httpClient, useUnionTypes, useOptions, useCancelableRequest, outputCore, outputModels } = options;
